...
import { outgoingStockRows as rows, outgoingStockColumns as columns } from "../lib"
import Row from './Row'

const OutgoingStockTable = () => {
      ...
      <Table variant="unstyled">
        ...
        <Tbody>
            ...
            {rowState.length !== 0 && rowState.map((k, i) => <>
              <Row k={k} i={i} noCount={true} action={action} which="outgoing_stock"/>
            </>)}
        </Tbody>
        <Tfoot>
          <Tr>
...
export default OutgoingStockTable